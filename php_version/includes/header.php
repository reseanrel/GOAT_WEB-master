        ...
        <aside class="sidebar" id="sidebar">
            ...
            <ul class="sidebar-nav">
                <?php if ($_SESSION['is_admin']): ?>
                     ...
                     <!-- Manage Users & Manage Pets now on Admin Dashboard only -->
            ...
            <div class="top-bar">
                ...
                <?php else: ?>
                    <div style="display:flex; align-items:center; gap: var(--spacing-md);">
                        ...
                        <div class="notification-dropdown" style="position:relative;">
                            <button type="button"
                                    class="notification-bell notification-bell-button"
                                ...
                                <span class="notification-badge" style="
                                    ...
                                    box-shadow: var(--shadow-sm);
                                ">
                                    <?php echo $totalUserNotifications; ?>
                                </span>
                            </button>
                            ...
                            <div class="notification-dropdown-panel" style="
                                ...
                                display:none;
                            ">
                                <a class="notification-dropdown-item" href="/lost_pets.php" style="display:flex; align-items:flex-start; gap: 12px; padding: 12px 12px; border-radius: var(--radius-lg); text-decoration:none; color: var(--color-text); transition: background-color 0.15s ease;">
                                    <i class="fas fa-exclamation-triangle" style="color: var(--color-error);"></i>
                                    <div class="notification-dropdown-text" style="display:flex; flex-direction:column; gap: 2px; min-width: 0;">
                                        <div class="notification-dropdown-title" style="font-weight: 800; color: var(--color-text); font-size: 14px;">Lost pets</div>
                                        <div class="notification-dropdown-sub" style="font-size: 13px; color: var(--color-text-secondary); font-weight: 600;"><?php echo (int)$userLostCount; ?> need attention</div>
                                    </div>
                                </a>

                                <a class="notification-dropdown-item" href="/user/manage_adoption_applications.php" style="display:flex; align-items:flex-start; gap: 12px; padding: 12px 12px; border-radius: var(--radius-lg); text-decoration:none; color: var(--color-text); transition: background-color 0.15s ease;">
                                    <i class="fas fa-heart" style="color: var(--color-primary);"></i>
                                    <div class="notification-dropdown-text" style="display:flex; flex-direction:column; gap: 2px; min-width: 0;">
                                        <div class="notification-dropdown-title" style="font-weight: 800; color: var(--color-text); font-size: 14px;">Adoption applications</div>
                                        <div class="notification-dropdown-sub" style="font-size: 13px; color: var(--color-text-secondary); font-weight: 600;"><?php echo (int)$userAdoptionCount; ?> pending review</div>
                                    </div>
                                </a>
                            </div>
                        </div>
    ...
    <?php endif; ?>
        ...
        <script>
            ...
            document.addEventListener('click', function(event) {
                const bellWrap = event.target.closest('.notification-dropdown');
                if (!bellWrap) closeNotificationDropdowns();
            });

            document.addEventListener('keydown', function(event) {
                if (event.key === 'Escape') closeNotificationDropdowns();
            });
            ...
            document.addEventListener('DOMContentLoaded', function() {
                ...
                if (pageTitle) {
                    ...
                    const titles = {
                        ...
                        'manage_adoption_applications': 'Adoption Applications'
                    };
