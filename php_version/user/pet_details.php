...
<div class="pet-details">
    <div class="pet-header">
        ...
        ?>
        <?php if ($photoOk): ?>
            <img class="pet-image-large" src="../uploads/<?php echo htmlspecialchars($pet['photo_url'], ENT_QUOTES, 'UTF-8'); ?>" alt="<?php echo htmlspecialchars($pet['name'], ENT_QUOTES, 'UTF-8'); ?>" />
        <?php else: ?>
    ...
    <div class="content-card medical-records">
        <h2 class="card-title">
            ...
            Medical Records
            <a href="medical_records.php?pet_id=<?php echo $petId; ?>" style="margin-left:auto; font-size:12px; font-weight:500; color:var(--color-primary); text-decoration:none; display:inline-flex; align-items:center; gap:4px;">
